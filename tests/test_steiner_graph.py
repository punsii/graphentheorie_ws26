...
def test_rejects_disconnected_graph():
    disconnected = Graph({1, 2, 3}, {Edge(1, 2, 1.0)})
    with pytest.raises(ValueError, match="connected"):
        SteinerGraph(disconnected, {1, 2})
